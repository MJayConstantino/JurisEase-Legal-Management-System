...
export function BillingsListHeader({
  onNewBill,
  statusFilter,
  ...
  hideMatterFilter = false,
}: BillingsListHeaderProps) {
  const [menuOpen, setMenuOpen] = useState(false);

  const { visibleMatters, setVisibleMatters, currentPage, setCurrentPage } =
    BillingStates();
  ...
  return (
    <div className="p-4 border-b bg-gray-50 dark:bg-gray-900 dark:border-gray-700 rounded-t-lg">
      ...
      <div className="hidden lg:flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        {/* Right: Status Filter */}
        <div className="flex flex-wrap gap-2 bg-gray-100 shadow dark:bg-gray-700 rounded-md justify-center sm:justify-start flex-shrink-0">
          <Button
              ...
              >
                ...
                >
                  <div className="p-0">
                    <SelectItem
                      value="all"
                      className="text-xs rounded-none border-b"
                    >
                      All
                    </SelectItem>
                  </div>
