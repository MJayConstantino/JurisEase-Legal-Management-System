...
/**
 * Main search dialog component that integrates all search functionality
 *
 * This component:
 * 1. Manages the search state and API calls
 * 2. Coordinates between filter components and results
 * 3. Handles navigation when results are clicked
 *
 * Required components:
 * - SearchByFilters: Collapsible filter section for search attributes
 * - SearchInFilters: Collapsible filter section for content types
 * - SearchResults: Collapsible results section with pagination
 */
